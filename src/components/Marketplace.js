...
export default function Marketplace() {
  ...
  const SkeletonTile = () => (
    <div className="w-full md:w-1/3 p-4">
      <div className="bg-gray-700 h-64 rounded-2xl shadow-lg animate-pulse"></div>
      <div className="h-6 bg-gray-700 rounded mt-4 animate-pulse"></div>
  ...
  return (
    <div className="min-h-screen bg-darkblue text-white font-poppins">
      ...
      <div className="flex flex-col items-center mt-20 px-4">
        ...
        <div className="w-full flex flex-col items-center my-10">
          {!dataFetched ? (
            // Display skeleton loading tiles
            <>
